                ...
                <el-aside width="200px" class="aside" style="border-right: solid 1px #e6e6e6;">
                    <el-menu :default-active="$route.path" style="border: 0">
                        <template v-for="menu in menuList">
                            <el-submenu :index="menu.url" v-if="menu.sub_menu.length > 0" :key="menu.url">
                                <template slot="title">
        ...
        data() {
            return {
                menuList: [
                    ...
                    {'icon': 'el-icon-user', 'name': '激活码管理', url: '/admin/active_code', sub_menu: []},
                    {'icon': 'el-icon-user', 'name': '单词管理', url: '/admin/word', sub_menu: []},
                    {'icon': 'el-icon-user', 'name': '单词分类管理', url: '/admin/word_category', sub_menu: []},
                ]
            }
        },
