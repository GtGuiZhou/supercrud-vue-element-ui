<template>
    <div>
        <div><el-button v-if="allowUpload" type="primary" plain @click="selectFile">选择图片</el-button></div>
        <div class="image-list">
            <div v-for="(img,index) in value" :key="index" class="avatar-box" :style="{width:imageWidth,height:imageHeight}">
